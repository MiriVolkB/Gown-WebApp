...
import { Edit2, X, Check, CheckCircle2 } from 'lucide-react';
...
export function DetailItem({ 
  ...
  }, [isEditing, rawValue, value, type, showSuccess]);
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 bg-slate-50/50">
              <h3 className="font-bold text-slate-800">
                {showSuccess ? "Success" : `Edit ${label}`}
              </h3>
              <button 
                onClick={closeModal}
            ...
            {showSuccess ? (
              <div className="flex flex-col items-center justify-center text-center space-y-4 min-h-[220px] p-5">
